    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-lg">
        <SheetHeader>
          ...
          <SheetDescription>
            Add a new module to organize your course content. Modules help structure your course into logical sections.
          </SheetDescription>
        </SheetHeader>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Enter a descriptive title for this module
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">
                The position of this module in the course (1 = first module)
              </p>
            </div>
          </div>
