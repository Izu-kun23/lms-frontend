...
export function InstructorSidebar({ role = "Instructor" }: InstructorSidebarProps) {
  ...
  return (
    <div className="flex flex-col h-full ">
      {/* Logo and Role */}
      <div className="p-1 ">
        <Link href="/instructor/dashboard" className="flex flex-col items-center gap-2 ">
          <div className="relative w-32 h-12 -mt-4 mb-5">
            <Image
      ...
      {/* Navigation */}
      <nav className="flex-1 space-y-10 p-4 overflow-y-auto">
        {navItems.map((item) => {
