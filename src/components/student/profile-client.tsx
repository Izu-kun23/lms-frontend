      ...
      <div className="flex-1 min-w-0 px-6 pt-6 pb-6 overflow-y-auto h-full flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-3xl shadow-lg overflow-hidden lg:sticky lg:top-8 lg:self-start backdrop-blur-sm">
              {/* Background */}
              ...
              <div className="px-6 pb-6 -mt-12 relative">
                {/* Avatar */}
                <div className="relative w-28 h-28 rounded-2xl overflow-hidden border-4 border-white dark:border-neutral-800 shadow-xl mx-auto mb-4 ring-2 ring-orange-200 dark:ring-orange-900/50">
                  <Image
                ...
                <div className="text-center space-y-3">
                  ...
                  <div className="flex flex-col gap-2 pt-2">
                    <span className="inline-flex justify-center items-center px-4 py-2 rounded-full text-xs font-semibold bg-gradient-to-r from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30 border border-orange-300 dark:border-orange-700 text-orange-700 dark:text-orange-300 uppercase tracking-wide shadow-sm">
                      {user.role}
                    </span>
                    
                    {user.emailVerified !== undefined && (
                      <div className={`inline-flex justify-center items-center gap-1.5 px-4 py-2 rounded-full text-xs font-medium border shadow-sm ${
                        user.emailVerified 
                  ...
                  <Button 
                    ...
                    className="w-full mt-4 inline-flex justify-center items-center text-white bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 focus:ring-4 focus:ring-orange-200 dark:focus:ring-orange-900 shadow-md font-medium rounded-xl text-sm px-4 py-2.5 transition-all duration-200"
                  >
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-3xl shadow-lg p-8 backdrop-blur-sm">
              <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 flex items-center gap-3">
                <div className="p-3 bg-gradient-to-br from-orange-100 to-orange-200 dark:from-orange-900/30 dark:to-orange-800/30 rounded-2xl shadow-sm">
            ...
            <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-3xl shadow-lg p-8 backdrop-blur-sm">
              <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 flex items-center gap-3">
                <div className="p-3 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 rounded-2xl shadow-sm">
                ...
                {emails.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      {item.isPrimary && (
                        <span className="px-3 py-1 text-xs font-semibold bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 border border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-300 rounded-full shadow-sm">
                          Primary
                        </span>
                      )}
                    </div>
            ...
            {user.school && (
              <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-3xl shadow-lg p-8 backdrop-blur-sm">
                <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 flex items-center gap-3">
                  <div className="p-3 bg-gradient-to-br from-purple-100 to-purple-200 dark:from-purple-900/30 dark:to-purple-800/30 rounded-2xl shadow-sm">
            ...
            <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-3xl shadow-lg p-8 backdrop-blur-sm">
              <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 flex items-center gap-3">
                <div className="p-3 bg-gradient-to-br from-teal-100 to-teal-200 dark:from-teal-900/30 dark:to-teal-800/30 rounded-2xl shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  <div className="flex flex-col items-center shrink-0">
                    <div className="w-5 h-5 rounded-full bg-gradient-to-br from-teal-500 to-teal-600 border-4 border-white dark:border-neutral-800 shadow-lg ring-2 ring-teal-200 dark:ring-teal-900/50"></div>
            ...
            <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-3xl shadow-lg p-8 backdrop-blur-sm">
              <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 flex items-center gap-3">
                <div className="p-3 bg-gradient-to-br from-indigo-100 to-indigo-200 dark:from-indigo-900/30 dark:to-indigo-800/30 rounded-2xl shadow-sm">
              ...
              <div className="space-y-3">
                <Button className="w-full inline-flex justify-start items-center text-neutral-700 dark:text-neutral-200 bg-neutral-50 dark:bg-neutral-700/50 box-border border border-neutral-200 dark:border-neutral-600 hover:bg-neutral-100 dark:hover:bg-neutral-700 focus:ring-4 focus:ring-neutral-200 dark:focus:ring-neutral-700 shadow-sm font-medium rounded-xl text-sm px-4 py-3 transition-all duration-200">
            ...
            {/* Danger Zone */}
            <div className="bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-950/30 dark:to-rose-950/30 border border-red-200 dark:border-red-800 rounded-3xl shadow-lg p-8 backdrop-blur-sm">
              <h3 className="text-xl font-bold text-red-900 dark:text-red-100 mb-3 flex items-center gap-3">
                <div className="p-3 bg-gradient-to-br from-red-100 to-rose-100 dark:from-red-900/40 dark:to-rose-900/40 rounded-2xl shadow-sm">
              ...
              <Button 
                ...
                className="inline-flex items-center text-white bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 border border-transparent focus:ring-4 focus:ring-red-300 dark:focus:ring-red-800 shadow-md font-medium rounded-xl text-sm px-6 py-3 transition-all duration-200"
              >
